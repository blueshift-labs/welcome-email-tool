...
function setupWelcomeSampleData() {
  ...
  const sampleData = [
    buildSampleRow(headers, {
      ...
      'Which Blueshift features are included': 'Email, Segments, Recommendations',
      ...
      'Delivery Strategist Name': 'Nathan She',
      'Delivery Strategist Email': 'nathan.she@blueconic.com',
      'Project Manager Name': 'Sarah Johnson',
      'Project Manager Email': 'sarah.johnson@blueconic.com',
      ...
      'Additional Contact 3 First Name': 'Charlie',
      'Additional Contact 3 Last Name': 'Brown',
      'Additional Contact 3 Email': 'charlie.brown@acmecorp.com',
      'Desired Kick-Off Date': '2026-08-15',
      'Kickoff Scheduled': 'Yes',
      'Kickoff Meeting URL': 'https://meet.google.com/abc-defg-hij',
      'CSM Assigned': 'Yes',
      'Product Consultant Assigned': 'Yes',
      'PM Included': 'Yes',
      'Delivery Included': 'Yes',
      'Delivery Assigned': 'Yes',
      'Contract Start Date': '2026-08-01',
      'Expected Go Live Date': '2026-09-15',
      'Description of company/deal': 'Enterprise customer with 50k users, focus on email personalization',
    ...
    buildSampleRow(headers, {
      ...
      'Which Blueshift features are included': 'Email, Push Notifications, In-App',
      ...
      'Delivery Strategist Name': 'Alex Martinez',
      'Delivery Strategist Email': 'alex.martinez@blueconic.com',
      'Project Manager Name': '',
      'Project Manager Email': '',
      ...
      'Additional Contact 3 First Name': 'Emma',
      'Additional Contact 3 Last Name': 'Wilson',
      'Additional Contact 3 Email': 'emma.wilson@techstart.io',
      ...
      'Delivery Included': 'Yes',
      'Delivery Assigned': 'Yes',
      'Contract Start Date': '2026-08-15',
      'Expected Go Live Date': '2026-10-01',
      'Description of company/deal': 'Professional tier customer, mobile-first strategy',
